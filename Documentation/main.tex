...
\twocolumn
	...
	\pagebreak
  	...
  	\textit{Character Passives} are sets of three (3) upgrades unique to each VTuber. Character Passives may be upgraded up to three (3) times. For more information on each Vtuber's's Character Passives, please refer to section \ref{VTubers}.
